// 이미지 및 리소스 로드 후 코드실행 - fetch 활용 - then : 성공시 , catch : 실패시
...
function swListShow(){
    swList.forEach((item,index)=>{
        ...
        //어떤(ex 이 예시에서 - swVisual) 슬라이드를 변경할 것인가?(API 참조)   
        //swVisual.slideToLoop()
...
//비주얼 슬라이드
    ...
    //swVisual 슬라이드 변경될때마다 하고 싶은일 진행
